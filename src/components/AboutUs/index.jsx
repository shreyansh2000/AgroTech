...
<h1 className="w-auto" style={{fontSize:40}}>The Team Behind Project</h1>
</div> 

 
        <div className="flex w-auto justify-center" style={{ marginTop: 100 , marginLeft:180 }}>
            ...
            <div className="col-sm-6 col-md-4">
                  ...
                  <div class="team-item">
                      ...
                      <div class="team-info"><p>AI Enthusiast</p></div>
