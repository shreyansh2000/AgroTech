...
<>
          ...
          />
            ...
            <div className="h-75% w-3/5 md:w-4/5 lg:w-3/5 xl:w-2/5 text-gray-600 space-y-5 p-8 shadow-xl border rounded-xl" style={{borderColor: '#39B68D'}}>
                    ...
                    className="w-full mt-2 px-3 py-2 text-3xl  text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg transition duration-300"
                        />
                <span className="absolute text-3xl justify-around items-centerr" onClick={handleToggle}>
                <Icon className="absolute right-3 top-4 " icon={icon} />
                        ...
                        <button
                            ...
                            className={`w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg text-2xl font-medium  ${isSigningIn ? 'cursor-not-allowed' : 'hover:bg-gray-100 transition duration-300 active:bg-gray-100'}`}>
